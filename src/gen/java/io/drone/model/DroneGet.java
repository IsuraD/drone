...
public class DroneGet   {
  ...
  **/
  ...
  public DroneGet seriealNumber(String seriealNumber) {
    this.seriealNumber = seriealNumber;
    return this;
  }
  ...
  **/
  ...
  public DroneGet model(ModelEnum model) {
    this.model = model;
    return this;
  }
  ...
  **/
  ...
  public DroneGet weightLimit(Integer weightLimit) {
    this.weightLimit = weightLimit;
    return this;
  }
  ...
  **/
  @JsonProperty("load")
  public LoadDrone getLoad() {
    return load;
  }

  public void setLoad(LoadDrone load) {
    this.load = load;
  }

  public DroneGet load(LoadDrone load) {
    this.load = load;
    return this;
  }
  ...
  **/
  ...
  public DroneGet batteryCapacity(Integer batteryCapacity) {
    this.batteryCapacity = batteryCapacity;
    return this;
  }
  ...
  **/
  ...
  public DroneGet state(StateEnum state) {
    this.state = state;
    return this;
  }
